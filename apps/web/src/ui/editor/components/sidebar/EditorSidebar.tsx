...
import { TypographyTab } from '@ui/editor/components/sidebar/tabs/TypographyTab';
import { StyleTab } from '@ui/editor/components/sidebar/tabs/StyleTab';
import { PositionTab } from '@ui/editor/components/sidebar/tabs/PositionTab';
import { EffectsTab } from '@ui/editor/components/sidebar/tabs/EffectsTab';
import { LayoutTab } from '@ui/editor/components/sidebar/tabs/LayoutTab';
import { CodeTab } from '@ui/editor/components/sidebar/tabs/CodeTab';

type TabId = 'templates' | 'captions' | 'typography' | 'style' | 'position' | 'effects' | 'layout' | 'code';
...
const RAIL: RailEntry[] = [
  ...
  { id: 'captions',   label: 'Captions',   icon: <Subtitles         size={ICON_SIZE} /> },
...
export const EditorSidebar = memo(function EditorSidebar(props: EditorSidebarProps) {
  ...
  const refsByTab: Record<TabId, React.RefObject<HTMLDivElement>> = {
  ...
  return (
    ...
    >
      <div className="relative flex-1 flex flex-col min-h-0 min-w-0 p-3">
        ...
        <Tabs.Content value="captions" className={SIDEBAR_CONTENT_CLASS} ref={captionsRef}>
          <EditorTab title="Captions">
            <CaptionsHost
              document={document}
