...
/**
 * Common-prefix / common-suffix diff. Minimal for single-keystroke
 * edits; for paste or select-and-retype it yields one larger middle
 * delete + insert, which is correct but not provably minimal — non-
 * minimal output only resets wordIds in the affected middle, the safe
 * direction.
 */
