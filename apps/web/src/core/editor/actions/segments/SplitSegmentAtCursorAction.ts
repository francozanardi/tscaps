...
import { CharOwnership } from '@core/editor/captions/domain/CharOwnership';
import { SegmentRecompiler, type NeighborWindow } from '@core/editor/captions/services/SegmentRecompiler';
