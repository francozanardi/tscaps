...
export interface ExportDependencies {
  ...
  readonly behindActorGatingService: BehindActorGatingService;
  readonly ensureSegmentMasksAction: EnsureSegmentMasksCachedAction;
}
...
export function bootExport(deps: ExportDependencies) {
  ...
  const run = new ExportVideoAction(
    ...
    deps.behindActorGatingService,
    deps.personSegmentationCacheRepository,
    deps.ensureSegmentMasksAction,
